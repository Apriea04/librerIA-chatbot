...
print('-'*106)
results = rag_tools.recommend_same_genre_as("3000 Years", 12) # Expected Animal Behavior genre: 	How Animals Talk: And Other Pleasant Studies of Birds and Beasts, 	Never Cry Wolf,	Cry Wolf, 	Can I Be Good?, Call of the Dolphins, ...
for idx, result in enumerate(results, start=1):
    print(f"{idx}. {result[0]} (Score: {result[1]:.8f})")
